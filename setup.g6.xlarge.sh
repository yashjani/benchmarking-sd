...
/usr/bin/python3 /home/ubuntu/benchmarking-sd/benchmark.py --server_name "g6.xlarge" --model_name "stabilityai/stable-diffusion-3-medium-diffusers" --ondemand_cost 0.8048 --spot_cost 0.1240 --reserved_one_year_cost 0.5239 --reserved_three_year_cost 0.3694
