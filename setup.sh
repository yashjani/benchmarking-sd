...
/usr/bin/python3 /home/ubuntu/benchmarking-sd/benchmark.py --server_name "g4dn.xlarge" --model_name "CompVis/stable-diffusion-v1-4" --ondemand_cost 0.5260 --spot_cost 0.1844 --reserved_one_year_cost 0.3310 --reserved_three_year_cost 0.2270

# Commit and push any changes
git add -A
git commit -m "g4dn.xlarge"
