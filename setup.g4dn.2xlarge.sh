...
/usr/bin/python3 /home/ubuntu/benchmarking-sd/benchmark.py --server_name "g4dn.2xlarge" --model_name "stabilityai/stable-diffusion-3-medium-diffusers" --ondemand_cost 0.7520 --spot_cost 0.2607 --reserved_one_year_cost 0.4740 --reserved_three_year_cost 0.3250

# Commit and push any changes
git add -A
git commit -m "g4dn.2xlarge"
