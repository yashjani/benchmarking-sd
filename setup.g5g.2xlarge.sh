...
/usr/bin/python3 /home/ubuntu/benchmarking-sd/benchmark.py --server_name "g5.2xlarge" --model_name "stabilityai/stable-diffusion-3-medium-diffusers" --ondemand_cost 1.212 --spot_cost 0.5509 --reserved_one_year_cost 0.7636 --reserved_three_year_cost 0.5236

# Commit and push any changes
git add -A
git commit -m "g5.xlarge"
