...
/usr/bin/python3 /home/ubuntu/benchmarking-sd/benchmark.py --server_name "p3.2xlarge" --model_name "CompVis/stable-diffusion-v1-4" --ondemand_cost 3.060 --spot_cost 1.559 --reserved_one_year_cost 2.088 --reserved_three_year_cost 1.132
