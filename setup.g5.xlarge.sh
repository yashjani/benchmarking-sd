...
/usr/bin/python3 /home/ubuntu/benchmarking-sd/benchmark.py --server_name "g5.xlarge" --model_name "CompVis/stable-diffusion-v1-4" --ondemand_cost 1.006 --spot_cost 0.4118 --reserved_one_year_cost 0.6338 --reserved_three_year_cost 0.4346
